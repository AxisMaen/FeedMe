...
"}")
        ...
        self.shoppingTableView.setMinimumSize(QtCore.QSize(743, 431))
        self.shoppingTableView.setStyleSheet("background-color: rgba(255, 255, 255, 255); border: 1px hidden; border-radius: 20px;")
        ...
        self.verticalLayout_7.addWidget(self.shoppingTableView)
